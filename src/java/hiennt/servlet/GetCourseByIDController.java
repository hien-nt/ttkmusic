...
import hiennt.Category.CategoryDAO;
import hiennt.Category.CategoryDTO;
...
public class GetCourseByIDController extends HttpServlet {
    private final String ERROR = "getCourseError.html";
    private final String SUCCESS = "updateCourse.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(course!=null && listCategory !=null ){
                url = SUCCESS;
            }
            ...
            log("GetCourseByIDController_ SQL" +ex.getMessage());
        }
    }
